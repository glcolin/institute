...
/**************************请求参数**************************/
        ...
        //必填，不能修改
        //服务器异步通知页面路径
        $notify_url = "http://hyinstitute.com/alipay/notify_url.php";
        //需http://格式的完整路径，不能加?id=123这类自定义参数

        //页面跳转同步通知页面路径
        $return_url = "http://hyinstitute.com/alipay/return_url.php";
        //需http://格式的完整路径，不能加?id=123这类自定义参数，不能写成http://localhost/

        //卖家支付宝帐户
        $seller_email = '13318495388';
        //必填
        ...
        $receive_phone = $_POST['WIDreceive_mobile'];
        //如：0571-88158090
...
$html_text = $alipaySubmit->buildRequestForm($parameter,"get", "跳轉中.......");
echo $html_text;
// echo '跳轉中';
