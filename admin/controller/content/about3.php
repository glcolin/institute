<?php 
class ControllerContentAbout3 extends Controller {
	private $error = array(); 
     
  	public function index() {
	
		$this->document->setTitle("护士出国");
		...
		//data
		$data = $this->model_content_content->getInterContent();
		...
		//actions
		$this->data['save'] = 'index.php?route=content/about3/update';
	...
	public function update() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
			...
			$this->model_content_content->updateInterContent($this->request->post);
