<?php 
class ControllerContentAbout2 extends Controller {
	private $error = array(); 
  	...
  	public function index() {
		...
		//data
		$data = $this->model_content_content->getAboutContent();
		...
		//actions
		$this->data['save'] = 'index.php?route=content/about2/update';
	...
	public function update() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
			...
			$this->model_content_content->updateAboutContent($this->request->post);
