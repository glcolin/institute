<?php 
class ControllerContentAbout extends Controller {
	private $error = array(); 
     
  	public function index() {
	
		$this->document->setTitle("首页简介");
		...
		//data
		$data = $this->model_content_content->getIntroContent();
		...
		//actions
		$this->data['save'] = 'index.php?route=content/about/update';
	...
	public function update() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
			...
			$this->model_content_content->updateIntroContent($this->request->post);
